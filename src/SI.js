...
function SI() {
  ...
  const SIanim = (event) => {
    ...
    event.target.style.width = "26vw";
    event.target.style.height = "9vw";
    event.target.style.marginLeft = "6vw";
    event.target.style.marginTop = "16.5vw";
    event.target.style.fontSize = "2.8vw";
